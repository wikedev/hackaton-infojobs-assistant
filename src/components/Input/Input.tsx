  ...
  return (
    <div className='p-12 w-full'>
      ...
      <div className="relative">
        ...
        <input type="search" id="search" className=" block w-full p-4 pzl-10  border text-black border-primary rounded-md " placeholder="Compara mi CV con las ofertas actuales" onChange={e => handleRequest(e.target.value)} value={request} />
